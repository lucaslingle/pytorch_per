...
def create_argparser():
    ...
    parser.add_argument("--num_env_steps_per_policy_update", type=int, default=64)
...
def main():
    ...
    if args.mode == 'train':
        ...
        alpha_annealing_fn = create_annealing_fn(
            ...
            start_step=int(args.alpha_annealing_start_step),
            end_step=int(args.max_env_steps_per_process))
        beta_annealing_fn = create_annealing_fn(
            initial_value=args.beta_init,
            final_value=1.0,
            do_annealing=bool(args.beta_annealing),
            start_step=int(args.beta_annealing_start_step),
            end_step=int(args.max_env_steps_per_process))
        epsilon_annealing_fn = create_annealing_fn(
            ...
            start_step=int(args.epsilon_annealing_start_step),
            end_step=int(args.epsilon_annealing_end_step))
